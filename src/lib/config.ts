...
export const SITE_CONFIG = {
  ...
  googleScriptUrl: process.env.GOOGLE_SCRIPT_URL || "https://script.google.com/macros/s/AKfycbz0bCj4Vltnb2OHRYqQGwbZ8PnzaqrXmXe4XlkmLLMzuhkNntp2BKBJEV9f_Wb8tpiMAA/exec",
};
