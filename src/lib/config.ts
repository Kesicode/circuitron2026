...
export const SITE_CONFIG = {
  ...
  googleScriptUrl: process.env.GOOGLE_SCRIPT_URL || "https://script.google.com/macros/s/AKfycbwhyeHKxZxPCQlfZPEaxJOp6IMksUHvITeNZO4YkEgKpSdHwBjfNz7cvDv_dhDnwtYp2A/exec",
};
