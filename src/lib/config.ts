...
export const SITE_CONFIG = {
  ...
  googleScriptUrl: process.env.GOOGLE_SCRIPT_URL || "https://script.google.com/macros/s/AKfycbwM7l2Y5FlgDRqVfCMU8TulKjsBRWdJB8GYqc5kBLQvyzAFRCQIYRfq97kcxgLbmKGebw/exec",
};
